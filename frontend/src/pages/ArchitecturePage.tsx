      ...
      <main className="max-w-7xl mx-auto px-8 pt-40 pb-32 relative z-10">
        <header className="max-w-3xl mb-24 space-y-8">
           ...
           <p className="text-xl text-text-dim font-medium leading-relaxed">
             The Content Agent System is built on a distributed agentic framework that prioritizes asynchronous execution, state isolation, and collaborative creative production.
           </p>
        </header>
              ...
              <div className="max-w-3xl relative z-10 space-y-12">
                 <div className="space-y-4">
                    ...
                    <p className="text-lg text-text-dim font-medium leading-relaxed">
                      Unlike traditional linear scripts, the Content Agent System agents communicate via a centralized <strong>SharedState</strong> schema. This allows for non-destructive, additive script building where each agent validates the previous one's output before contributing.
                    </p>
                 </div>
